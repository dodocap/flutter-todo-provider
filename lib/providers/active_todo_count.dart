...
class ActiveTodoCount extends StateNotifier<ActiveTodoCountState> with LocatorMixin {
  ...
  void update(Locator watch) {
    ...
    state = state.copyWith(activeTodoCount: todos.where((todo) => !todo.completed).length);
